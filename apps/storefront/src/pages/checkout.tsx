...
return (
  <main className="max-w-3xl mx-auto px-4 py-8 animate-fadeIn">
    ...
    <div className="mt-6 flex flex-col items-end">
      {/* 🧾 Only show total & place order when there are items */}
      {items.length > 0 && (
        <>
          ...
          <button
            ...
            className="mt-4 bg-primary-600 hover:bg-primary-700 text-white px-6 py-3 rounded-lg shadow-sm transition-all duration-200 focus:outline-none focus:ring-4 focus:ring-primary-200 disabled:opacity-50"
          >
